...
public class AccountController : Controller
{
    ...
    public IActionResult Sesion(string userOEmail, string contraseña)
    {
        ...
        if (usuario != null)
        {
            ...
            HttpContext.Session.SetString("Foto", usuario.Foto ?? "https://t3.ftcdn.net/jpg/00/64/67/80/360_F_64678017_zUpiZFjj04cnLri7oADnyMH0XBYyQghG.jpg");
            HttpContext.Session.SetString("FotoHeader", usuario.FotoHeader ?? "https://media.istockphoto.com/id/1128826884/es/vector/ning%C3%BAn-s%C3%ADmbolo-de-vector-de-imagen-falta-icono-disponible-no-hay-galer%C3%ADa-para-este-momento.jpg?s=612x612&w=0&k=20&c=9vnjI4XI3XQC0VHfuDePO7vNJE7WDM8uzQmZJ1SnQgk=");
